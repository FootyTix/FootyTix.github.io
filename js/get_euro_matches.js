$(function () {
    ...
    //     dataType: 'json'
    //     }).done (function(data){
    fetch('https://footballtickets-by-gakuseimiler.com/wp-content/football-data/json/ec_matches.json')
    ...
    .then(data => {
        ...
        function getHomeTeam (game) {
            if (game.homeTeam.id == null) {
                ...
                return '<td><img src="' + game.homeTeam.crest
        ...
        function getAwayTeam (game) {
            if (game.awayTeam.id == null) {
                ...
                return '<td><img src="' + game.awayTeam.crest
