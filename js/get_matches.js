...
$(function () {
    ...
    Promise.all([
    fetch('https://footballtickets-by-gakuseimiler.com/wp-content/football-data/json/pl_scheduled_matches.json').then(res => res.json()),
    fetch('https://footballtickets-by-gakuseimiler.com/wp-content/football-data/json/bl1_scheduled_matches.json').then(res => res.json()),
    fetch('https://footballtickets-by-gakuseimiler.com/wp-content/football-data/json/pd_scheduled_matches.json').then(res => res.json()),
    fetch('https://footballtickets-by-gakuseimiler.com/wp-content/football-data/json/sa_scheduled_matches.json').then(res => res.json()),
    fetch('https://footballtickets-by-gakuseimiler.com/wp-content/football-data/json/fl1_scheduled_matches.json').then(res => res.json()),
