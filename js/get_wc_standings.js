$(function () {
    $.ajaxSetup({
        headers: { "X-Auth-Token": "ed51211801874c0d89f1d7269f7ee702" }
    });
    $.getJSON('https://api.football-data.org/v2/competitions/WC/standings?standingType=TOTAL', function (data) {
        //JSON取得後の処理
